...
namespace Music\SecurityBundle\Service\Authenticator;
...
class TokenAuthenticatorService extends AbstractGuardAuthenticator
{
    ...
    public function __construct($encodingFactory)
    {
    ...
    {
        return new JsonResponse(['message' => $this->translator->trans('Authentication required')], 401);
    }
    ...
    {
        if (!$token = $request->headers->get('X-API-TOKEN')) {
